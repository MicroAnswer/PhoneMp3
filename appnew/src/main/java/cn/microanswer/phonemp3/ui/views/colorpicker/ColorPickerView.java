...
public class ColorPickerView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, answer.android.phonemp3.R.styleable.ColorPickerView);
        showAlphaPanel = a.getBoolean(answer.android.phonemp3.R.styleable.ColorPickerView_cpv_alphaChannelVisible, false);
        alphaSliderText = a.getString(answer.android.phonemp3.R.styleable.ColorPickerView_cpv_alphaChannelText);
        sliderTrackerColor = a.getColor(answer.android.phonemp3.R.styleable.ColorPickerView_cpv_sliderColor, 0xFFBDBDBD);
        borderColor = a.getColor(answer.android.phonemp3.R.styleable.ColorPickerView_cpv_borderColor, 0xFF6E6E6E);
        a.recycle();

        applyThemeColors(context);

        huePanelWidthPx = cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), HUE_PANEL_WDITH_DP);
        alphaPanelHeightPx = cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), ALPHA_PANEL_HEIGH_DP);
        panelSpacingPx = cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), PANEL_SPACING_DP);
        circleTrackerRadiusPx = cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), CIRCLE_TRACKER_RADIUS_DP);
        sliderTrackerSizePx = cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), SLIDER_TRACKER_SIZE_DP);
        sliderTrackerOffsetPx = cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), SLIDER_TRACKER_OFFSET_DP);

        mRequiredPadding = getResources().getDimensionPixelSize(answer.android.phonemp3.R.dimen.cpv_required_padding);
    ...
    private void initPaintTools() {
        ...
        satValTrackerPaint.setStrokeWidth(cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), 2));
        ...
        hueAlphaTrackerPaint.setStrokeWidth(cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), 2));
        hueAlphaTrackerPaint.setAntiAlias(true);

        alphaTextPaint.setColor(0xff1c1c1c);
        alphaTextPaint.setTextSize(cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), 14));
    ...
    private void drawSatValPanel(Canvas canvas) {
        ...
        canvas.drawCircle(p.x, p.y, circleTrackerRadiusPx - cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), 1), satValTrackerPaint);
    ...
    private void drawAlphaPanel(Canvas canvas) {
        ...
        if (alphaSliderText != null && !alphaSliderText.equals("")) {
            canvas.drawText(alphaSliderText, rect.centerX(), rect.centerY() + cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), 4), alphaTextPaint);
        }
    ...
    private int getPreferredWidth() {
        ...
        int width = cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), 200);

        return (width + huePanelWidthPx + panelSpacingPx);
    }

    private int getPreferredHeight() {
        int height = cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), 200);
    ...
    private void setUpAlphaRect() {
        ...
        alphaPatternDrawable = new AlphaPatternDrawable(cn.microanswer.phonemp3.util.Utils.UI.dp2px(getContext(), 4));

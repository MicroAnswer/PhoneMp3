...
public class ColorPanelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, answer.android.phonemp3.R.styleable.ColorPanelView);
        shape = a.getInt(answer.android.phonemp3.R.styleable.ColorPanelView_cpv_colorShape, ColorShape.CIRCLE);
        showOldColor = a.getBoolean(answer.android.phonemp3.R.styleable.ColorPanelView_cpv_showOldColor, false);
        if (showOldColor && shape != ColorShape.CIRCLE) {
            throw new IllegalStateException("Color preview is only available in circle mode");
        }
        borderColor = a.getColor(answer.android.phonemp3.R.styleable.ColorPanelView_cpv_borderColor, DEFAULT_BORDER_COLOR);
        a.recycle();
        ...
        borderWidthPx = Utils.UI.dp2px(context, 1);
        ...
        if (shape == ColorShape.CIRCLE) {
            Bitmap bitmap = ((BitmapDrawable) context.getResources().getDrawable(R.mipmap.cpv_alpha)).getBitmap();
    ...
    private void setUpColorRect() {
        ...
        alphaPattern = new cn.microanswer.phonemp3.ui.views.colorpicker.AlphaPatternDrawable(Utils.UI.dp2px(getContext(), 4));

...
class ColorPaletteAdapter extends BaseAdapter {
    ...
    private final class ViewHolder {
        ...
        ViewHolder(Context context) {
            ...
            colorPanelView = (ColorPanelView) view.findViewById(answer.android.phonemp3.R.id.cpv_color_panel_view);
            imageView = (ImageView) view.findViewById(answer.android.phonemp3.R.id.cpv_color_image_view);
        ...
        void setup(int position) {
            ...
            imageView.setImageResource(selectedPosition == position ? answer.android.phonemp3.R.drawable.cpv_preset_checked : 0);
            if (alpha != 255) {

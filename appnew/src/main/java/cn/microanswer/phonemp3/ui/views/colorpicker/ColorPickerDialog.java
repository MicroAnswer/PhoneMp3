...
package cn.microanswer.phonemp3.ui.views.colorpicker;
...
public class ColorPickerDialog extends DialogFragment implements OnTouchListener, ColorPickerView.OnColorChangedListener, TextWatcher {
    ...
    /**
     * Create a new Builder for creating a {@link cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog} instance
     *
     * @return The {@link Builder builder} to create the {@link cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog}.
     */
    ...
    // -- PRESETS --------------------------
    cn.microanswer.phonemp3.ui.views.colorpicker.ColorPaletteAdapter adapter;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                .setView(rootView)
                .setPositiveButton(answer.android.phonemp3.R.string.cpv_select, new DialogInterface.OnClickListener() {
                    @Override
        ...
        if (dialogType == TYPE_CUSTOM && getArguments().getBoolean(ARG_ALLOW_PRESETS)) {
            neutralButtonStringRes = answer.android.phonemp3.R.string.cpv_presets;
        } else if (dialogType == TYPE_PRESETS && getArguments().getBoolean(ARG_ALLOW_CUSTOM)) {
            neutralButtonStringRes = answer.android.phonemp3.R.string.cpv_custom;
        } else {
                ...
                public void onClick(View v) {
                    ...
                    switch (dialogType) {
                        case TYPE_CUSTOM:
                            ...
                            ((Button) v).setText(answer.android.phonemp3.R.string.cpv_custom);
                            rootView.addView(createPresetsView());
                            break;
                        case TYPE_PRESETS:
                            dialogType = TYPE_CUSTOM;
                            ((Button) v).setText(answer.android.phonemp3.R.string.cpv_presets);
                            rootView.addView(createPickerView());
                    }
                }
            });
    ...
    View createPickerView() {
        View contentView = View.inflate(getActivity(), answer.android.phonemp3.R.layout.cpv_dialog_color_picker, null);
        colorPicker = (ColorPickerView) contentView.findViewById(answer.android.phonemp3.R.id.cpv_color_picker_view);
        ColorPanelView oldColorPanel = (ColorPanelView) contentView.findViewById(answer.android.phonemp3.R.id.cpv_color_panel_old);
        newColorPanel = (ColorPanelView) contentView.findViewById(answer.android.phonemp3.R.id.cpv_color_panel_new);
        ImageView arrowRight = (ImageView) contentView.findViewById(answer.android.phonemp3.R.id.cpv_arrow_right);
        hexEditText = (EditText) contentView.findViewById(answer.android.phonemp3.R.id.cpv_hex);
    ...
    View createPresetsView() {
        View contentView = View.inflate(getActivity(), answer.android.phonemp3.R.layout.cpv_dialog_presets, null);
        shadesLayout = (LinearLayout) contentView.findViewById(answer.android.phonemp3.R.id.shades_layout);
        transparencySeekBar = (SeekBar) contentView.findViewById(answer.android.phonemp3.R.id.transparency_seekbar);
        transparencyPercText = (TextView) contentView.findViewById(answer.android.phonemp3.R.id.transparency_text);
        GridView gridView = (GridView) contentView.findViewById(answer.android.phonemp3.R.id.gridView);
        ...
        if (showColorShades) {
            ...
            contentView.findViewById(answer.android.phonemp3.R.id.shades_divider).setVisibility(View.GONE);
        }

        adapter = new cn.microanswer.phonemp3.ui.views.colorpicker.ColorPaletteAdapter(new cn.microanswer.phonemp3.ui.views.colorpicker.ColorPaletteAdapter.OnColorSelectedListener() {
            @Override
        ...
        if (showAlphaSlider) {
            ...
            contentView.findViewById(answer.android.phonemp3.R.id.transparency_layout).setVisibility(View.GONE);
            contentView.findViewById(answer.android.phonemp3.R.id.transparency_title).setVisibility(View.GONE);
        }
    ...
    void createColorShades(@ColorInt final int color) {
        ...
        if (shadesLayout.getChildCount() != 0) {
            for (int i = 0; i < shadesLayout.getChildCount(); i++) {
                ...
                final ColorPanelView cpv = (ColorPanelView) layout.findViewById(answer.android.phonemp3.R.id.cpv_color_panel_view);
                ImageView iv = (ImageView) layout.findViewById(answer.android.phonemp3.R.id.cpv_color_image_view);
        ...
        final int horizontalPadding = getResources().getDimensionPixelSize(answer.android.phonemp3.R.dimen.cpv_item_horizontal_padding);

        for (final int colorShade : colorShades) {
            int layoutResId;
            if (colorShape == ColorShape.SQUARE) {
                layoutResId = answer.android.phonemp3.R.layout.cpv_color_item_square;
            } else {
                layoutResId = answer.android.phonemp3.R.layout.cpv_color_item_circle;
            }

            final View view = View.inflate(getActivity(), layoutResId, null);
            final ColorPanelView colorPanelView = (ColorPanelView) view.findViewById(answer.android.phonemp3.R.id.cpv_color_panel_view);
            ...
            colorPanelView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v.getTag() instanceof Boolean && (Boolean) v.getTag()) {
                        colorPickerDialogListener.onColorSelected(dialogId, cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog.this.color);
                        dismiss();
                        return; // already selected
                    }
                    cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog.this.color = colorPanelView.getColor();
                    adapter.selectNone();
                    for (int i = 0; i < shadesLayout.getChildCount(); i++) {
                        FrameLayout layout = (FrameLayout) shadesLayout.getChildAt(i);
                        ColorPanelView cpv = (ColorPanelView) layout.findViewById(answer.android.phonemp3.R.id.cpv_color_panel_view);
                        ImageView iv = (ImageView) layout.findViewById(answer.android.phonemp3.R.id.cpv_color_image_view);
                        iv.setImageResource(cpv == v ? answer.android.phonemp3.R.drawable.cpv_preset_checked : 0);
    ...
    public static final class Builder {
        ...
        @StringRes
        int dialogTitle = answer.android.phonemp3.R.string.cpv_default_title;
        @DialogType
        ...
        ColorPickerDialogListener colorPickerDialogListener = null;
        @ColorShape
         ...
         *
         * @param dialogType Either {@link cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog#TYPE_CUSTOM} or {@link cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog#TYPE_PRESETS}.
         * @return This builder object for chaining method calls
         */
        ...
        /**
         * Create the {@link cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog} instance.
         *
         * @return A new {@link cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog}.
         * @see #show(Activity)
         */
        public cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog create() {
            cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog dialog = new cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog();
        ...
        /**
         * Create and show the {@link cn.microanswer.phonemp3.ui.views.colorpicker.ColorPickerDialog} created with this builder.
         *
